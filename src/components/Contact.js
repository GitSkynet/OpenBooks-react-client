                        ...
                        <div className="screen-body">
                            <div className="screen-body-item left">
                                ...
                                <div className="app-contact">
                                    <img className="img-contact-info" src="https://res.cloudinary.com/ytyt/image/upload/v1614856971/undraw_contact_us_15o2_hltwlr.svg" alt="contact logo" />
                                    CONTACT INFO : +62 81 314 928 595</div>
                            </div>
